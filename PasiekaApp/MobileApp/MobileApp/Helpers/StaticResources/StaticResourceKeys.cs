...
{
    public struct StaticResourceKeys
    {
        ...
        public static readonly string NullToBooleanConverter = nameof(NullToBooleanConverter);
        public static readonly string QueenAgeConverter = nameof(QueenAgeConverter);
        public static readonly string IsSelectedToColorConverter = nameof(IsSelectedToColorConverter);
        ...
        public static readonly string ReviewHiveHistortListDataTemplateSelector = nameof(ReviewHiveHistortListDataTemplateSelector);
        public static readonly string ByteArrayToImageSourceConverter = nameof(ByteArrayToImageSourceConverter);
